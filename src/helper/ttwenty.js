let vertical = [
    ['XM', 'XL', 'XK', 'XJ', 'XI', 'XH', 'XG', 'XF', 'XE', 'XD', 'XC', 'XB', 'XA', 'XN', 'XO', 'XP', 'XQ', 'XR', 'XS', 'XT', 'XU', 'XV', 'XW', 'XY', 'XZ'],
    ['WM', 'WL', 'WK', 'WJ', 'WI', 'WH', 'WG', 'WF', 'WE', 'WD', 'WC', 'WB', 'WA', 'WZ', 'WX', 'WY', 'WV', 'WU', 'WT', 'WS', 'WR', 'WQ', 'WP', 'WO', 'WN'],
    ['VM', 'VL', 'VK', 'VJ', 'VI', 'VH', 'VG', 'VF', 'VE', 'VD', 'VC', 'VB', 'VA', 'VN', 'VO', 'VP', 'VQ', 'VR', 'VS', 'VT', 'VU', 'VV', 'VW', 'VX', 'VY', 'VZ'],
    ['UM', 'UL', 'UK', 'UJ', 'UI', 'UH', 'UG', 'UF', 'UE', 'UD', 'UC', 'UB', 'UA', 'UZ', 'UX', 'UY', 'UW', 'UV', 'UU', 'UT', 'US', 'UR', 'UQ', 'UP', 'UO', 'UN'],
    ['TM', 'TL', 'TK', 'TJ', 'TI', 'TH', 'TG', 'TF', 'TE', 'TD', 'TC', 'TB', 'TA', 'TN', 'TO', 'TP', 'TQ', 'TR', 'TS', 'TT', 'TU', 'TV', 'TW', 'TX', 'TY', 'TZ'],
    ['SM', 'SL', 'SK', 'SJ', 'SI', 'SH', 'SG', 'SF', 'SE', 'SD', 'SC', 'SB', 'SA', 'SZ', 'SX', 'SY', 'SV', 'SU', 'ST', 'SS', 'SR', 'SQ', 'SP', 'SO', 'SN'],
    ['RM', 'RL', 'RK', 'RJ', 'RI', 'RH', 'RG', 'RF', 'RE', 'RD', 'RC', 'RB', 'RA', 'RN', 'RO', 'RP', 'RQ', 'RR', 'RS', 'RT', 'RU', 'RV', 'RW', 'RX', 'RY', 'RZ'],
    ['QM', 'QL', 'QK', 'QJ', 'QI', 'QH', 'QG', 'QF', 'QE', 'QD', 'QC', 'QB', 'QA', 'QZ', 'QX', 'QY', 'QV', 'QU', 'QT', 'QS', 'QR', 'QQ', 'QP', 'QO', 'QN'],
    ['PM', 'PL', 'PK', 'PJ', 'PI', 'PH', 'PG', 'PF', 'PE', 'PD', 'PC', 'PB', 'PA', 'PN', 'PO', 'PP', 'PQ', 'PR', 'PS', 'PT', 'PU', 'PV', 'PW', 'PX', 'PY', 'PZ'],
    ['OM', 'OL', 'OK', 'OJ', 'OI', 'OH', 'OG', 'OF', 'OE', 'OD', 'OC', 'OB', 'OA', 'OZ', 'OX', 'OY', 'OV', 'OU', 'OT', 'OS', 'OR', 'OQ', 'OP', 'OO', 'ON'],
    ['NM', 'NL', 'NK', 'NJ', 'NI', 'NH', 'NG', 'NF', 'NE', 'ND', 'NC', 'NB', 'NA', 'NN', 'NO', 'NP', 'NQ', 'NR', 'NS', 'NT', 'NU', 'NV', 'NW', 'NX', 'NY', 'NZ'],
    ['MM', 'ML', 'MK', 'MJ', 'MI', 'MH', 'MG', 'MF', 'ME', 'MD', 'MC', 'MB', 'MA', 'MZ', 'MX', 'MY', 'MV', 'MU', 'MT', 'MS', 'MR', 'MQ', 'MP', 'MO', 'MN'],
